 ...
 *   1. service Key - API를 호출하기 위한 인증키
 *   2. LAWD_CD - 법정동 코드 10자리 중 앞 5자리  -  구 지역코드 guLawdCd지역 코드 값(5자리) 예) 41135
...
public class ApartmentApiResource {
    ...
    public Resource getResource(String lawdCd, YearMonth yearMonth) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Failed to create UrlResource", e);
        }
    }
}
